...
class CheddarProduct(object):
    ...
    def __repr__(self):
        return 'CheddarProduct: %s' % self.product_code
...
class PricingPlan(object):
    ...
    def __repr__(self):
        return 'PricingPlan: %s (%s)' % (self.name, self.code)
...
class Customer(object):
    ...
    def create_one_time_invoice(self, charges):
        ...
        for n, charge in enumerate(charges):
            ...
            if 'description' in list(charge.keys()):
...
class Subscription(object):
    ...
    def load_data(self, id, gateway_token, cc_first_name, cc_last_name,
        ...
        if not hasattr(self, 'items'):
            self.items = {}
        for code, item_map in list(items_map.items()):
            ...
            if code in list(self.items.keys()):
